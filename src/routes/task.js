...
const checklistDependetRouter = express.Router();//permite criar rotas
...
simpleRouter.delete('/:id', async(req, res) => {
    try {
        ...
        res.status(404).render('pages/error', { errors: 'Erro ao remover uma tarefa' })
    }
})
...
module.exports = {
    checklistDepedent: checklistDependetRouter,
    simple: simpleRouter
}